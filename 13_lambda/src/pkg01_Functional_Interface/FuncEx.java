...
public class FuncEx {
  ...
  public static void main(String[] args) {
   ...
   /* MyInterfaceA a = new MyInterfaceA() {
     ...
     * 3. 문법
     *    public interface AA {void method(String param)AA ; 
     * 
     * 
    ...
    MyInterfaceB b = (String param) -> System.out.println("param");
    b.method("hello world");
    
    // 코드가 return만 있으면 중괄호와 return 키워드 생략 가능
    MyInterfaceC c = () -> {return "hello world";};
